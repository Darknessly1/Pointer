...
const Footer = () => {
    return (
        <div className="mt-8 bg-violet-900 pt-9 bg-white/40 text-black border-2 m-8 border-black rounded-3xl ">
            <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                    <div className="md:w-[316px]">
                        ...
                        <p className="mt-[18px] text-[15px] font-normal text-black/[80%]">
                            ...
                            officiis enim animi placeat eaque nesciunt alias beatae id, at
                            dicta.
                        </p>
                    ...
                    <div className="md:w-[316px] ">
                        ...
                        <ContactItem
                            icon={<ContactIcon3 />}
                            href="mailto:help@lorem.com"
                            text="Sub Nerul, Mumbia, India, 123456"
                            description="Address"
                        />
                    </div>
                    <div className="mt-6 flex w-full flex-col justify-between text-black  sm:flex-row md:mt-0 md:max-w-[341px]">
                        <div className="">
                            ...
                            <ul>
                                ...
                                <PageLink href="/our-tutors">News</PageLink>
                                <PageLink href="/become-a-tutor">Contact</PageLink>
                                <PageLink href="/plans-and-pricing">
                                    Plans and pricing
                                </PageLink>
                                <PageLink href="/terms-and-conditions">
                                    Terms and conditions
                                </PageLink>
                                <PageLink href="/privacy-policy">Privcay policy</PageLink>
                            </ul>
                        </div>
                ...
                <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
                    <p className="text-[10px] font-normal text-black md:text-[12px]">
...
const ContactItem = ({ icon, href, text, description }) => (
    <div className="mt-[23px] flex x">
        <div className=" flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
            {icon}
        </div>
        <div className="ml-[18px]">
            <a href={href} className="font-Inter text-[14px] font-medium text-black">
                {text}
            </a>
