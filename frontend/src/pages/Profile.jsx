                    ...
                    <div className="col-span-4 sm:col-span-9">
                        <div className="bg-white shadow rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="border-2 border-black p-3 rounded-3xl">
                                    <h2 className="text-xl font-bold mt-1 mb-4">Experience</h2>
                                    <div className="mb-6">
                                ...
                                <div className="border-2 border-black p-3 rounded-3xl">
                                    <h2 className="text-xl font-bold mt-1 mb-4">Project</h2>
                                </div>
                            </div>
                        </div>
                    </div>
