...
export const fetchingWorker = async (req, res) => {
    try {
...
export const fetchingWorkers = async (req, res) => {
    try {
...
export const addingWorker = async (req, res) => {
...
export const addingWorkerDetails = async (req, res) => {
    try {
...
export const deleteWorkersRecord = async (req, res) => {
    try {
        const { workerId, year, month, date } = req.params;
